    ...
    <div class="container-fluid">
      ...
      <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link fw-bolder active" aria-current="page" href="<?= URLROOT ?>">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-bolder" href="<?= URLROOT ?>/home/login">Login</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $("#booking_form").submit(function(e) {
        ...
        var error = 0;
        console.log(booking_weight, balance_capacity);
